    ...
    <div class="container">
        ...
        <div class="panel panel-primary">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <form method="post" action="{{url('/products/edit/'.$products->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea cols="5" rows="5" class="form-control" name="descriptions" required> {{ $products->description }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="produced_on" value="{{ $products->producedon}}" required/>
                                </div>
                    ...
                    <br>
                    <a href="{{action('ProductController@index')}}" class="btn btn-primary">Update</a>
